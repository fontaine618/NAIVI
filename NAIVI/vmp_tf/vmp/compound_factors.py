...
from NAIVI.vmp_tf import BernoulliArray
from NAIVI.vmp_tf.distributions.gaussianarray import GaussianArray
from NAIVI.vmp_tf.vmp.vmp_factors2 import VMPFactor, AddVariance, Probit, Product, ExpandTranspose, Concatenate, Sum, Split, Logistic

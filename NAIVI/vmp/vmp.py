...
class VMP:
    ...
    def _initialize_model(
        ...
        self._initialize_binary_model(K, N, binary_covariates, latent, logistic_approximation, logistic_elbo)
        self._initialize_continuous_model(K, N, continuous_covariates, latent)
        self._initialize_edge_model(K, edge_index_left, edge_index_right, edges, heterogeneity, latent, logistic_approximation, logistic_elbo)
    ...
    def _initialize_edge_model(self, K, edge_index_left, edge_index_right, edges, heterogeneity, latent, logistic_approximation, logistic_elbo):
        ...
        edge_model = Logistic(1, parent=edge_logit, method=logistic_approximation, elbo=logistic_elbo)
    ...
    def _initialize_binary_model(self, K, N, binary_covariates, latent, logistic_approximation, logistic_elbo):
        ...
        bin_model = Logistic(p_bin, parent=logit_bin, method=logistic_approximation, elbo=logistic_elbo)

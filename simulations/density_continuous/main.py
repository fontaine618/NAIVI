...
def run(traj):
    ...
    print(p_cts, alpha_mean, seed, elbo, mse, auroc, dist_inv, dist_proj, density)
    return p_cts, alpha_mean, seed, elbo, mse, auroc, dist_inv, dist_proj, density
...
def main():
    ...
    env = Environment(
        trajectory=SIM_NAME,
        comment="Experiment on density with continuous covariates",
        log_config=None,
        multiproc=False,
        ncores=1,

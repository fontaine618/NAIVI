...
if __name__ == "__main__":
    ...
    main(
        ...
        which=WHICH,
        explore_dict={
            "data.N": np.array([100, 500]),  # Vary N
            "data.K": np.array([2]),
            "data.p_bin": np.array([0]),
            "data.p_cts": np.array([0, 10, 25, 50, 100, 200, 500, 1000]),  # 2 sub-experiments
            ...
            "fit.mcmc_n_sample": np.array([20]),
            "fit.mcmc_n_chains": np.array([5]),
            "fit.mcmc_n_warmup": np.array([10]),
            "fit.lr": np.array([0.01]),
            "fit.eps": np.array([0.0001]),
